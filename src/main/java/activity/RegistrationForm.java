...
import com.example.palmfarm.MainActivity;
import com.example.palmfarm.R;
...
public class RegistrationForm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (session.isLoggedIn()) {
            ...
            Intent intent = new Intent(RegistrationForm.this,
                    MainActivity.class);
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if(!password.equals(confirmPass)){
                    toastLong("Password and Confirm Password do not match!");
                }
                    ...
                    if(isEmailValid(email)) {
                        ...
                        toastLong("Enter valid email id!");
                    }
                }
                else {
                    toastLong("Please enter your details!");
                }
            }
        });
    ...
    public final boolean isEmailValid(String e)
    {
        String regExpn =
                "^(([\\w-]+\\.)+[\\w-]+|([a-zA-Z]{1}|[\\w-]{2,}))@"
